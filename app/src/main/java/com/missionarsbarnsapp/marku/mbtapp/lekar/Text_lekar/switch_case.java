...
public class switch_case {
    ...
    final Text_lasse_gar_i_ringen lasse_gar_i_ringen = new Text_lasse_gar_i_ringen();
    ...
    public String Gettext(String s){
        ...
        switch (s) {
            ...
            case "Lasse går i ringen": return lasse_gar_i_ringen.getText_lasse_gar_i_ringen();
