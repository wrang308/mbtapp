...
public class Text_vad_ar_mbt {


    private static String text = "MBT är ett årligt återkommande läger för barn och ungdomar. Lägret äger rum på Hjälmargården v. 29 med talare, lovsångsteam, själavårdare och andra ledare som alla har erfarenhet av mission eller att vara missionärsbarn.\n" +
            "\n" +
            ...
            "\n" +
            "\n" +
            "MBT tar emot missionärsbarn från alla svenska kristna missionsorganisationer. Idag står Pingst International och Evangeliska Frikyrkan (EFK) officiellt bakom lägret.\n" +
            "\n" +
            "Syfte\n" +
            "\n" +
            ...
            "Ta gärna del av vårt material om du vill veta mer om MBT och missionärsbarn. Vill du komma i kontakt med oss så skicka ett mail till ledning@mbt.se";
